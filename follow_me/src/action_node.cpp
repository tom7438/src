...
void compute_translation()
{
    ...
    if ( cond_translation )
    {
        ...
        float error_derivation_translation = error_previous_translation - error_translation;
...
void combine_rotation_and_translation()
{
    ...
    ROS_INFO("coef_rotation: %f, rotation_speed: %f, coef_translation: %f, translation_speed: %f", coef_translation, rotation_speed*180/M_PI, coef_translation, translation_speed);
